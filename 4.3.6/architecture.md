...
For the most current information on available regions, see the [FAQ section](https://learn.microsoft.com/en-us/azure/virtual-machines/np-series?source=recommendations#frequently-asked-questions) of the NP-series site.
